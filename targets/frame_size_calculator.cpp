...
void til::frame_size_calculator::do_indexing_node(til::indexing_node * const node, int lvl) {
  // EMPTY
}
void til::frame_size_calculator::do_memory_address_node(til::memory_address_node * const node, int lvl) {
  // EMPTY
}
void til::frame_size_calculator::do_memory_alloc_node(til::memory_alloc_node * const node, int lvl) {
  // EMPTY
}
